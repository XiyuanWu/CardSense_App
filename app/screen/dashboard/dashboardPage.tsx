...
export default function DashboardPage() {
  ...
  const allTransactions: Transaction[] = [
    { id: '1', merchant: 'Amazon', date: 'Dec 18, 2025', category: 'Online Shopping', amount: 48.59 },
    { id: '2', merchant: 'Walmart', date: 'Dec 18, 2025', category: 'Groceries', amount: 25.63 },
    { id: '3', merchant: 'Starbuck', date: 'Dec 15, 2025', category: 'Dining', amount: 5.63 },
  ];
  ...
  useEffect(() => {
    ...
    const availableHeight = screenHeight - safeAreaTop - safeAreaBottom - navBarHeight - titleHeight - cardsHeight - transactionHeaderHeight - padding - bottomNavPadding;
      ...
      >
        <View style={styles.content}>
          ...
          <View style={[styles.card, styles.cardLeft]}>
            ...
            <Text style={styles.cardValue}>${monthlySpending.toFixed(2)}</Text>
          </View>
          ...
          <View style={[styles.card, styles.cardTall]}>
            ...
            <View style={styles.budgetInfoContainer}>
              <Text style={styles.budgetSubtext}>Monthly Budget({budgetMonth})</Text>
            ...
            {displayedTransactions.length === 0 ? (
              <View style={styles.emptyState}>
                <Text style={styles.emptyStateText}>
                  You don&apos;t have any transaction right now. Go and add first one!
                </Text>
              </View>
            ) : (
